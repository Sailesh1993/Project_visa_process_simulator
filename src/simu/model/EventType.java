...
public enum EventType implements IEventType {
    ...
    public int getServicePointNumber() {
        switch (this) {
            case END_APPLICATION_ENTRY:
                return 1; // SP1: Application Entry & Appointment Booking
            case END_DOC_SUBMISSION:
                return 2; // SP2: Doc Submission room - Interviews
            case END_BIOMETRICS:
                return 2; // SP2b: Biometrics room (sub-process of SP2)
            case END_DOC_CHECK:
                return 3; // SP3: Doc check room - Backgrounds, verifications
            case END_DECISION:
                return 4; // SP4: Decision room - Approve/Reject
            case MISSING_DOCS_RESOLVED:
                return 2; // SP2a: Missing Doc waiting room (sub-process of SP2)
            default:
                return 0; // Not associated with a specific service point
        }
    }
