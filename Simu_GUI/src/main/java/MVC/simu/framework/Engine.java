...
public abstract class Engine extends Thread implements IEngine {  // NEW DEFINITIONS
	...
	public Engine(IControllerMtoV controller) {	// NEW
		...
		/* Service Points are created in MVC.simu.model-package's class who is inheriting the Engine class */
	}
	...
	protected abstract void initialization(); 	// Defined in MVC.simu.model-package's class who is inheriting the Engine class
	protected abstract void runEvent(Event t);	// Defined in MVC.simu.model-package's class who is inheriting the Engine class
	protected abstract void results(); 			// Defined in MVC.simu.model-package's class who is inheriting the Engine class
}